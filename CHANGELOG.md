...
- Registra o papel de governança da planilha (`VENDAS GRALHA IMÓVEIS 2025.xlsx` / `PROCESSOS DE VENDAS 2026`) como matriz oficial de auditoria, conferência e homologação, sob atualização de Fernanda Silva e validação oficial de Marco Roennau (CSO), sem atuação como fonte viva do portal.
