  ...
  const ai = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "Quando a métrica histórica solicitada estiver indisponível, responda em no máximo três parágrafos curtos e 120 palavras. Diga objetivamente qual histórico falta; apresente somente a fotografia atual relacionada devolvida pela ferramenta, incluindo o total na etapa e o total com status geral Em aberto quando disponíveis; e esclareça que essa fotografia não equivale ao evento histórico. Não repita listas de fontes ou limitações, não use termos internos de implementação, não diga que falta confirmação de contrato e não ofereça alternativas irrelevantes.",
